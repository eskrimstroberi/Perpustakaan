...
public class petugas implements user {
    ...
    private ArrayList<String> namaKariyawan = new ArrayList<String>(); //enkapsulasi, modifier
    private ArrayList<String> alamat = new ArrayList<String>();
    private ArrayList<String> telpon = new ArrayList<String>();
    
    public petugas (){ //nama class sama nama ini sama fdisebut konstruktor atau termasuk pbo
        this.namaKariyawan.add("lutfi");
        this.alamat.add("Malang");
        this.telpon.add("08220939");
        
        this.namaKariyawan.add("henri");
